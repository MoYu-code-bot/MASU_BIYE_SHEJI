...
export const getMyReservations = () => request.get('/api/reservations')
...
// ==================== Review (Customer) ====================
export const createReview = (data) => request.post('/api/reviews', data)

// ==================== Admin Store ====================
export const adminGetStores = (params) => request.get('/admin/stores', { params })
export const adminAddStore = (data) => request.post('/admin/stores', data)
...
export const adminAddDish = (data) => request.post('/admin/dishes', data)
...
// ==================== Admin Review ====================
export const adminGetReviews = (params) => request.get('/admin/reviews', { params })
...
export const adminAddBanner = (data) => request.post('/admin/banners', data)
...
// ==================== Admin Announcement ====================
export const adminGetAnnouncements = (storeId) => request.get('/admin/announcements', { params: { storeId } })
