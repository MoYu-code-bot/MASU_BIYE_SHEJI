...
object dm_electric_car_analysis {
  def main(args: Array[String]): Unit = {
    ...
    /****************************************************************************
     * 指标表1：月度销售趋势表（dm_monthly_sales_trend）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表2：季度销售趋势表（dm_quarterly_sales_trend）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表3：年度销售趋势表（dm_yearly_sales_trend）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表4：地区销售分析表（dm_region_sales_analysis）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表8：价格区间分析表（dm_price_range_analysis）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表10：电池容量分析表（dm_battery_capacity_analysis）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表11：续航里程分析表（dm_range_analysis）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表12：驱动形式分析表（dm_drive_type_analysis）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表13：充电效率分析表（dm_charging_efficiency_analysis）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表14：智能化水平分析表（dm_intelligence_level_analysis）
     ***************************************************************************/
    ss.sql(
      """
    ...
    /****************************************************************************
     * 指标表15：过户状态分析表（dm_transfer_status_analysis）
     ***************************************************************************/
    ss.sql(
      """
